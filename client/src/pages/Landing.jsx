            ...
            <header className="relative overflow-hidden pt-12 pb-24 md:pt-20 md:pb-40">
                <div className="max-w-[1200px] mx-auto px-6 relative z-10 text-center lg:text-left flex flex-col lg:flex-row items-center gap-12">
                    ...
                    <div className="lg:w-1/2 relative">
                        {/* Custom Hero Image */}
                        <img 
                            src="/discord_style_saas_hero.png" 
                            alt="SaaSify Platform" 
                            className="w-full h-auto rounded-3xl shadow-[0_32px_64px_-12px_rgba(0,0,0,0.5)] transform lg:scale-110 lg:translate-x-12"
                        />
                        
                        {/* Ambient Particles (Floating elements) */}
                        <div className="absolute -top-10 -right-10 w-24 h-24 bg-white/10 rounded-full blur-2xl animate-pulse"></div>
                        <div className="absolute -bottom-20 -left-10 w-40 h-40 bg-indigo-400/20 rounded-full blur-3xl"></div>
                    </div>
                </div>
